...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,151 | 🐛 119 | 🌐 Markdown | 📅 2026-08-09
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,178 | 🐛 274 | 🌐 TypeScript | 📅 2026-08-13: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 9,995 | 🐛 248 | 🌐 Ruby | 📅 2026-08-09: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [rabl](https://github.com/nesquena/rabl) ⭐ 3,634 | 🐛 123 | 🌐 Ruby | 📅 2026-03-18: Generate JSON and XML from any ruby object.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,569 | 🐛 73 | 🌐 Python | 📅 2026-08-12: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,645 | 🐛 144 | 🌐 Python | 📅 2026-07-29: Sanic is a Flask-like Python 3.5+ web server that's written to go fast.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,795 | 🐛 159 | 🌐 Python | 📅 2026-07-31: Falcon is a low-level, high-performance Python framework for building HTTP APIs, app backends, and higher-level frameworks.
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,371 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-12: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,060 | 🐛 50 | 🌐 Go | 📅 2026-08-13: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [Servant](https://github.com/haskell-servant/servant) ⭐ 1,968 | 🐛 297 | 🌐 Haskell | 📅 2026-08-10: A Type-Level Web DSL.
...
* [Plug](https://github.com/elixir-plug/plug) ⭐ 3,012 | 🐛 4 | 🌐 Elixir | 📅 2026-07-23: A specification and conveniences for composable modules between web applications.
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,596 | 🐛 387 | 🌐 Haskell | 📅 2026-08-13: Serve a RESTful API from any existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,610 | 🐛 151 | 🌐 Go | 📅 2026-08-11: pREST is a way to serve a RESTful API from any databases written in Go.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,301 | 🐛 318 | 🌐 PHP | 📅 2026-08-09: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
...
* [Dream Factory](https://github.com/dreamfactorysoftware/dreamfactory) ⭐ 1,778 | 🐛 65 | 🌐 Shell | 📅 2026-08-12: Turn any database into an API platform.

## API Client Development Tools

### General

* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,667 | 🐛 5,706 | 🌐 Java | 📅 2026-08-13: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
* [Swagger CodeGen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,781 | 🐛 3,447 | 🌐 Mustache | 📅 2026-08-04: Generate client libraries automatically from a Swagger-compliant server.
...
* [Serverpod](https://github.com/serverpod/serverpod) ⭐ 3,240 | 🐛 507 | 🌐 Dart | 📅 2026-08-13: Serverpod is a next-generation app and web server, built for the Flutter community. It allows you to write your server-side code in Dart, automatically generate your APIs, and hook up your database with minimal effort. Serverpod is open-source, and you can host your server anywhere.

## API Documentation

* [Slate](https://github.com/lord/slate) ⚠️ Archived: Static site generated documentation for your API.
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,970 | 🐛 1,428 | 🌐 JavaScript | 📅 2026-08-13: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,873 | 🐛 451 | 🌐 TypeScript | 📅 2026-08-11: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Elements](https://github.com/stoplightio/elements) ⭐ 2,449 | 🐛 271 | 🌐 TypeScript | 📅 2026-08-12: Web Components-based API documentation for OpenAPI 3.x/2.x
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,022 | 🐛 782 | 🌐 TypeScript | 📅 2026-08-05: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,142 | 🐛 203 | 🌐 Rust | 📅 2026-08-13: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,451 | 🐛 890 | 🌐 Go | 📅 2026-08-13: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,333 | 🐛 240 | 🌐 Go | 📅 2026-08-11: A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by [consul](https://www.consul.io) by eBay.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,473 | 🐛 94 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,142 | 🐛 203 | 🌐 Rust | 📅 2026-08-13: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,590 | 🐛 854 | 🌐 Java | 📅 2026-08-13: A tool to test your API for known security vulnerabilities, with a great CI integration.
...
[Pull Requests](https://github.com/yosriady/api-development-tools/pulls) ⭐ 4,016 | 🐛 42 | 📅 2025-12-20 are most welcome!
