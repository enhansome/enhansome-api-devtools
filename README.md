...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,211 | 🐛 79 | 🌐 Markdown | 📅 2026-09-10
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,205 | 🐛 224 | 🌐 TypeScript | 📅 2026-09-09: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,008 | 🐛 238 | 🌐 Ruby | 📅 2026-09-10: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,232 | 🐛 81 | 🌐 Python | 📅 2026-09-01: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,798 | 🐛 156 | 🌐 Python | 📅 2026-09-07: Falcon is a low-level, high-performance Python framework for building HTTP APIs, app backends, and higher-level frameworks.
...
* [Connexion](https://github.com/zalando/connexion) ⭐ 4,610 | 🐛 185 | 🌐 Python | 📅 2026-09-07: Swagger/OpenAPI First framework for Python on top of Flask with automatic endpoint validation and OAuth2 support
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,632 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-10: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,141 | 🐛 37 | 🌐 Go | 📅 2026-09-10: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,653 | 🐛 404 | 🌐 Haskell | 📅 2026-09-10: Serve a RESTful API from any existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,616 | 🐛 156 | 🌐 Go | 📅 2026-09-10: pREST is a way to serve a RESTful API from any databases written in Go.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,293 | 🐛 334 | 🌐 PHP | 📅 2026-09-10: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,737 | 🐛 5,757 | 🌐 Java | 📅 2026-09-10: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
* [Swagger CodeGen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,787 | 🐛 3,444 | 🌐 Mustache | 📅 2026-08-18: Generate client libraries automatically from a Swagger-compliant server.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,005 | 🐛 1,136 | 🌐 JavaScript | 📅 2026-09-09: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,906 | 🐛 449 | 🌐 TypeScript | 📅 2026-09-10: OpenAPI/Swagger-generated API Reference Documentation.
* [Aglio](https://github.com/danielgtaylor/aglio) ⭐ 4,747 | 🐛 134 | 🌐 CoffeeScript | 📅 2019-05-13: An API Blueprint renderer with theme support that outputs static HTML.
* [Elements](https://github.com/stoplightio/elements) ⭐ 2,458 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-09: Web Components-based API documentation for OpenAPI 3.x/2.x
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,266 | 🐛 819 | 🌐 TypeScript | 📅 2026-09-10: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,192 | 🐛 206 | 🌐 Rust | 📅 2026-09-10: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,707 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/master/Guidelines.md) ⭐ 23,330 | 🐛 177 | 📅 2026-08-05
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,807 | 🐛 916 | 🌐 Go | 📅 2026-09-10: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
* [Zuul](https://github.com/Netflix/zuul) ⭐ 14,074 | 🐛 16 | 🌐 Java | 📅 2026-09-02: An edge service that provides dynamic routing, monitoring, resiliency, security, and more.
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,341 | 🐛 237 | 🌐 Go | 📅 2026-09-09: A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by [consul](https://www.consul.io) by eBay.
* [Oathkeeper](https://github.com/ory/oathkeeper) ⭐ 3,598 | 🐛 107 | 🌐 Go | 📅 2026-07-27: OIdentity & Access Proxy (IAP) that authorizes HTTP requests based on sets of rules. Integrates with ORY Hydra.
...
* [API Security checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,314 | 🐛 2 | 📅 2026-07-21: Checklist of the most important security countermeasures when designing, testing, and releasing your API.
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,530 | 🐛 97 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,192 | 🐛 206 | 🌐 Rust | 📅 2026-09-10: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,758 | 🐛 860 | 🌐 Java | 📅 2026-09-10: A tool to test your API for known security vulnerabilities, with a great CI integration.
