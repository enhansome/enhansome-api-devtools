...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,212 | 🐛 80 | 🌐 Markdown | 📅 2026-09-10
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,205 | 🐛 224 | 🌐 TypeScript | 📅 2026-09-11: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,008 | 🐛 239 | 🌐 Ruby | 📅 2026-09-11: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,255 | 🐛 81 | 🌐 Python | 📅 2026-09-01: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,801 | 🐛 157 | 🌐 Python | 📅 2026-09-07: Falcon is a low-level, high-performance Python framework for building HTTP APIs, app backends, and higher-level frameworks.
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,641 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-11: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,144 | 🐛 37 | 🌐 Go | 📅 2026-09-11: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,658 | 🐛 403 | 🌐 Haskell | 📅 2026-09-11: Serve a RESTful API from any existing PostgreSQL database.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,293 | 🐛 335 | 🌐 PHP | 📅 2026-09-10: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,738 | 🐛 5,759 | 🌐 Java | 📅 2026-09-11: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
* [Swagger CodeGen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,786 | 🐛 3,445 | 🌐 Mustache | 📅 2026-08-18: Generate client libraries automatically from a Swagger-compliant server.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,009 | 🐛 1,129 | 🌐 JavaScript | 📅 2026-09-11: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,906 | 🐛 449 | 🌐 TypeScript | 📅 2026-09-11: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Elements](https://github.com/stoplightio/elements) ⭐ 2,459 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-09: Web Components-based API documentation for OpenAPI 3.x/2.x
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,287 | 🐛 820 | 🌐 TypeScript | 📅 2026-09-10: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,192 | 🐛 203 | 🌐 Rust | 📅 2026-09-11: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,706 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/master/Guidelines.md) ⭐ 23,331 | 🐛 178 | 📅 2026-08-05
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,815 | 🐛 918 | 🌐 Go | 📅 2026-09-11: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
* [Zuul](https://github.com/Netflix/zuul) ⭐ 14,075 | 🐛 15 | 🌐 Java | 📅 2026-09-11: An edge service that provides dynamic routing, monitoring, resiliency, security, and more.
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,341 | 🐛 236 | 🌐 Go | 📅 2026-09-10: A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by [consul](https://www.consul.io) by eBay.
* [Oathkeeper](https://github.com/ory/oathkeeper) ⭐ 3,599 | 🐛 107 | 🌐 Go | 📅 2026-07-27: OIdentity & Access Proxy (IAP) that authorizes HTTP requests based on sets of rules. Integrates with ORY Hydra.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,534 | 🐛 98 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,192 | 🐛 203 | 🌐 Rust | 📅 2026-09-11: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,763 | 🐛 862 | 🌐 Java | 📅 2026-09-10: A tool to test your API for known security vulnerabilities, with a great CI integration.
