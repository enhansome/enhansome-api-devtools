...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,178 | 🐛 81 | 🌐 Markdown | 📅 2026-08-24
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,188 | 🐛 273 | 🌐 TypeScript | 📅 2026-08-25: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,004 | 🐛 236 | 🌐 Ruby | 📅 2026-08-24: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [jbuilder](https://github.com/rails/jbuilder) ⭐ 4,420 | 🐛 46 | 🌐 Ruby | 📅 2026-06-01: Create JSON structures via a Builder-style DSL.
* [rabl](https://github.com/nesquena/rabl) ⭐ 3,633 | 🐛 122 | 🌐 Ruby | 📅 2026-03-18: Generate JSON and XML from any ruby object.
* [roar](https://github.com/trailblazer/roar) ⭐ 1,839 | 🐛 18 | 🌐 Ruby | 📅 2023-01-17: Parse and render REST API documents using representers.
* [pliny](https://github.com/interagent/pliny) ⭐ 807 | 🐛 20 | 🌐 Ruby | 📅 2026-04-29: Opinionated template Sinatra app for writing APIs in Ruby.

### Python

* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,837 | 🐛 77 | 🌐 Python | 📅 2026-08-25: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [flask-restful](https://github.com/flask-restful/flask-restful) ⭐ 6,917 | 🐛 145 | 🌐 Python | 📅 2024-07-19: Simple framework for creating REST APIs.
...
* [Connexion](https://github.com/zalando/connexion) ⭐ 4,611 | 🐛 187 | 🌐 Python | 📅 2026-08-03: Swagger/OpenAPI First framework for Python on top of Flask with automatic endpoint validation and OAuth2 support
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,455 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-25: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
* [Restify](https://github.com/restify/node-restify) ⭐ 10,685 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-24: Node.js REST framework specifically meant for web service APIs.
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,079 | 🐛 44 | 🌐 Go | 📅 2026-08-25: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [Akka HTTP](https://github.com/akka/akka-http) ⭐ 1,350 | 🐛 579 | 🌐 Scala | 📅 2026-08-24: The Akka HTTP modules implement a full server- and client-side HTTP stack on top of akka-actor and akka-stream.
...
* [Servant](https://github.com/haskell-servant/servant) ⭐ 1,965 | 🐛 299 | 🌐 Haskell | 📅 2026-08-22: A Type-Level Web DSL.
...
* [Plug](https://github.com/elixir-plug/plug) ⭐ 3,013 | 🐛 4 | 🌐 Elixir | 📅 2026-08-13: A specification and conveniences for composable modules between web applications.
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,624 | 🐛 391 | 🌐 Haskell | 📅 2026-08-24: Serve a RESTful API from any existing PostgreSQL database.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,299 | 🐛 331 | 🌐 PHP | 📅 2026-08-20: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
* [Dingo API](https://github.com/dingo/api) ⭐ 9,368 | 🐛 189 | 🌐 PHP | 📅 2022-05-19: A RESTful API package for the Laravel and Lumen frameworks
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,180 | 🐛 2 | 🌐 PHP | 📅 2026-08-24: API framework on top of Symfony with JSON-LD, Schema.org and Hydra support
...
* [Dream Factory](https://github.com/dreamfactorysoftware/dreamfactory) ⭐ 1,782 | 🐛 64 | 🌐 Shell | 📅 2026-08-18: Turn any database into an API platform.

## API Client Development Tools

### General

* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,684 | 🐛 5,717 | 🌐 Java | 📅 2026-08-25: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
* [Swagger CodeGen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,777 | 🐛 3,447 | 🌐 Mustache | 📅 2026-08-18: Generate client libraries automatically from a Swagger-compliant server.
* [AutoRest](https://github.com/Azure/autorest) ⭐ 4,798 | 🐛 22 | 🌐 TypeSpec | 📅 2026-08-12: Generate client libraries for RESTful web services

### Ruby

* [faraday](https://github.com/lostisland/faraday) ⭐ 5,950 | 🐛 62 | 🌐 Ruby | 📅 2026-08-12: Simple, but flexible HTTP client library, with support for multiple backends.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,986 | 🐛 1,142 | 🌐 JavaScript | 📅 2026-08-25: Dynamically generate documentation from a Swagger-compliant API.
...
* [Elements](https://github.com/stoplightio/elements) ⭐ 2,453 | 🐛 273 | 🌐 TypeScript | 📅 2026-08-25: Web Components-based API documentation for OpenAPI 3.x/2.x
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,095 | 🐛 802 | 🌐 TypeScript | 📅 2026-08-25: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,157 | 🐛 206 | 🌐 Rust | 📅 2026-08-25: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Prism](https://github.com/stoplightio/prism) ⭐ 5,013 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-13: a set of packages for API mocking and contract testing with OpenAPI v2 (formerly known as Swagger) and OpenAPI v3.x, including mock servers and a validation proxy.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,689 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/master/Guidelines.md) ⭐ 23,325 | 🐛 176 | 📅 2026-08-05
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,579 | 🐛 924 | 🌐 Go | 📅 2026-08-25: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,494 | 🐛 94 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,157 | 🐛 206 | 🌐 Rust | 📅 2026-08-25: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,680 | 🐛 860 | 🌐 Java | 📅 2026-08-21: A tool to test your API for known security vulnerabilities, with a great CI integration.
...
[Pull Requests](https://github.com/yosriady/api-development-tools/pulls) ⭐ 4,017 | 🐛 44 | 📅 2025-12-20 are most welcome!
