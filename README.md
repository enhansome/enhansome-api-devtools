...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,182 | 🐛 81 | 🌐 Markdown | 📅 2026-08-24
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,189 | 🐛 275 | 🌐 TypeScript | 📅 2026-08-26: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,856 | 🐛 78 | 🌐 Python | 📅 2026-08-25: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [Connexion](https://github.com/zalando/connexion) ⭐ 4,611 | 🐛 184 | 🌐 Python | 📅 2026-08-03: Swagger/OpenAPI First framework for Python on top of Flask with automatic endpoint validation and OAuth2 support
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,461 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-26: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,085 | 🐛 43 | 🌐 Go | 📅 2026-08-26: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [Servant](https://github.com/haskell-servant/servant) ⭐ 1,966 | 🐛 299 | 🌐 Haskell | 📅 2026-08-22: A Type-Level Web DSL.
...
* [Plug](https://github.com/elixir-plug/plug) ⭐ 3,013 | 🐛 4 | 🌐 Elixir | 📅 2026-08-26: A specification and conveniences for composable modules between web applications.
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,630 | 🐛 391 | 🌐 Haskell | 📅 2026-08-26: Serve a RESTful API from any existing PostgreSQL database.
...
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,180 | 🐛 3 | 🌐 PHP | 📅 2026-08-24: API framework on top of Symfony with JSON-LD, Schema.org and Hydra support
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,685 | 🐛 5,708 | 🌐 Java | 📅 2026-08-26: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,988 | 🐛 1,138 | 🌐 JavaScript | 📅 2026-08-26: Dynamically generate documentation from a Swagger-compliant API.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,099 | 🐛 804 | 🌐 TypeScript | 📅 2026-08-26: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,161 | 🐛 203 | 🌐 Rust | 📅 2026-08-26: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/master/Guidelines.md) ⭐ 23,327 | 🐛 176 | 📅 2026-08-05
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,601 | 🐛 907 | 🌐 Go | 📅 2026-08-26: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,497 | 🐛 94 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,161 | 🐛 203 | 🌐 Rust | 📅 2026-08-26: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,684 | 🐛 856 | 🌐 Java | 📅 2026-08-26: A tool to test your API for known security vulnerabilities, with a great CI integration.
