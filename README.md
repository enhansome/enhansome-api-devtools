...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,217 | 🐛 80 | 🌐 Markdown | 📅 2026-09-11
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,209 | 🐛 222 | 🌐 TypeScript | 📅 2026-09-17: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,006 | 🐛 242 | 🌐 Ruby | 📅 2026-09-18: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,424 | 🐛 80 | 🌐 Python | 📅 2026-09-14: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,639 | 🐛 149 | 🌐 Python | 📅 2026-07-29: Sanic is a Flask-like Python 3.5+ web server that's written to go fast.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,800 | 🐛 156 | 🌐 Python | 📅 2026-09-18: Falcon is a low-level, high-performance Python framework for building HTTP APIs, app backends, and higher-level frameworks.
...
* [hug](https://github.com/timothycrosley/hug) ⭐ 6,877 | 🐛 189 | 🌐 Python | 📅 2024-07-04: hug aims to make developing Python driven APIs as simple as possible, but no simpler.
* [apistar](https://github.com/encode/apistar) ⚠️ Archived: A smart Web API framework, designed for Python3.
* [Connexion](https://github.com/zalando/connexion) ⭐ 4,612 | 🐛 186 | 🌐 Python | 📅 2026-09-07: Swagger/OpenAPI First framework for Python on top of Flask with automatic endpoint validation and OAuth2 support
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,687 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-18: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
* [Restify](https://github.com/restify/node-restify) ⭐ 10,687 | 🐛 132 | 🌐 JavaScript | 📅 2026-09-04: Node.js REST framework specifically meant for web service APIs.
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,160 | 🐛 38 | 🌐 Go | 📅 2026-09-18: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,669 | 🐛 400 | 🌐 Haskell | 📅 2026-09-18: Serve a RESTful API from any existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,618 | 🐛 153 | 🌐 Go | 📅 2026-09-18: pREST is a way to serve a RESTful API from any databases written in Go.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,290 | 🐛 334 | 🌐 PHP | 📅 2026-09-17: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
* [Dingo API](https://github.com/dingo/api) ⭐ 9,375 | 🐛 189 | 🌐 PHP | 📅 2022-05-19: A RESTful API package for the Laravel and Lumen frameworks
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,185 | 🐛 3 | 🌐 PHP | 📅 2026-09-01: API framework on top of Symfony with JSON-LD, Schema.org and Hydra support
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,750 | 🐛 5,749 | 🌐 Java | 📅 2026-09-17: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
* [Swagger CodeGen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,788 | 🐛 3,445 | 🌐 Mustache | 📅 2026-08-18: Generate client libraries automatically from a Swagger-compliant server.
* [AutoRest](https://github.com/Azure/autorest) ⭐ 4,798 | 🐛 25 | 🌐 TypeSpec | 📅 2026-09-13: Generate client libraries for RESTful web services

### Ruby

* [faraday](https://github.com/lostisland/faraday) ⭐ 5,949 | 🐛 78 | 🌐 Ruby | 📅 2026-09-16: Simple, but flexible HTTP client library, with support for multiple backends.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,013 | 🐛 1,128 | 🌐 JavaScript | 📅 2026-09-16: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,916 | 🐛 446 | 🌐 TypeScript | 📅 2026-09-16: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Elements](https://github.com/stoplightio/elements) ⭐ 2,463 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-15: Web Components-based API documentation for OpenAPI 3.x/2.x
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,343 | 🐛 827 | 🌐 TypeScript | 📅 2026-09-16: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,205 | 🐛 200 | 🌐 Rust | 📅 2026-09-18: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Prism](https://github.com/stoplightio/prism) ⭐ 5,033 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-03: a set of packages for API mocking and contract testing with OpenAPI v2 (formerly known as Swagger) and OpenAPI v3.x, including mock servers and a validation proxy.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,712 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/master/Guidelines.md) ⭐ 23,332 | 🐛 179 | 📅 2026-08-05
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,894 | 🐛 939 | 🌐 Go | 📅 2026-09-18: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
* [Zuul](https://github.com/Netflix/zuul) ⭐ 14,081 | 🐛 16 | 🌐 Java | 📅 2026-09-11: An edge service that provides dynamic routing, monitoring, resiliency, security, and more.
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,341 | 🐛 241 | 🌐 Go | 📅 2026-09-18: A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by [consul](https://www.consul.io) by eBay.
* [Oathkeeper](https://github.com/ory/oathkeeper) ⭐ 3,602 | 🐛 107 | 🌐 Go | 📅 2026-07-27: OIdentity & Access Proxy (IAP) that authorizes HTTP requests based on sets of rules. Integrates with ORY Hydra.
...
* [API Security checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,319 | 🐛 2 | 📅 2026-07-21: Checklist of the most important security countermeasures when designing, testing, and releasing your API.
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,548 | 🐛 98 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,205 | 🐛 200 | 🌐 Rust | 📅 2026-09-18: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,785 | 🐛 861 | 🌐 Java | 📅 2026-09-18: A tool to test your API for known security vulnerabilities, with a great CI integration.
...
[Pull Requests](https://github.com/yosriady/api-development-tools/pulls) ⭐ 4,018 | 🐛 52 | 📅 2025-12-20 are most welcome!
