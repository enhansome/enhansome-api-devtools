...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,157 | 🐛 121 | 🌐 Markdown | 📅 2026-08-13
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,182 | 🐛 273 | 🌐 TypeScript | 📅 2026-08-17: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 9,997 | 🐛 246 | 🌐 Ruby | 📅 2026-08-17: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,643 | 🐛 86 | 🌐 Python | 📅 2026-08-17: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,645 | 🐛 146 | 🌐 Python | 📅 2026-07-29: Sanic is a Flask-like Python 3.5+ web server that's written to go fast.
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,394 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-17: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,064 | 🐛 51 | 🌐 Go | 📅 2026-08-17: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,603 | 🐛 391 | 🌐 Haskell | 📅 2026-08-16: Serve a RESTful API from any existing PostgreSQL database.
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,676 | 🐛 5,715 | 🌐 Java | 📅 2026-08-17: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
...
* [Serverpod](https://github.com/serverpod/serverpod) ⭐ 3,243 | 🐛 501 | 🌐 Dart | 📅 2026-08-17: Serverpod is a next-generation app and web server, built for the Flutter community. It allows you to write your server-side code in Dart, automatically generate your APIs, and hook up your database with minimal effort. Serverpod is open-source, and you can host your server anywhere.

## API Documentation

* [Slate](https://github.com/lord/slate) ⚠️ Archived: Static site generated documentation for your API.
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,974 | 🐛 1,426 | 🌐 JavaScript | 📅 2026-08-17: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,877 | 🐛 451 | 🌐 TypeScript | 📅 2026-08-17: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,049 | 🐛 795 | 🌐 TypeScript | 📅 2026-08-16: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,147 | 🐛 203 | 🌐 Rust | 📅 2026-08-15: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Prism](https://github.com/stoplightio/prism) ⭐ 5,007 | 🐛 149 | 🌐 TypeScript | 📅 2026-08-13: a set of packages for API mocking and contract testing with OpenAPI v2 (formerly known as Swagger) and OpenAPI v3.x, including mock servers and a validation proxy.
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/master/Guidelines.md) ⭐ 23,316 | 🐛 176 | 📅 2026-08-05
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,465 | 🐛 895 | 🌐 Go | 📅 2026-08-17: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,480 | 🐛 93 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,147 | 🐛 203 | 🌐 Rust | 📅 2026-08-15: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,623 | 🐛 854 | 🌐 Java | 📅 2026-08-17: A tool to test your API for known security vulnerabilities, with a great CI integration.
