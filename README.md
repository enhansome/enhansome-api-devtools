...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,210 | 🐛 80 | 🌐 Markdown | 📅 2026-09-11
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,205 | 🐛 224 | 🌐 TypeScript | 📅 2026-09-14: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,006 | 🐛 238 | 🌐 Ruby | 📅 2026-09-13: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,333 | 🐛 79 | 🌐 Python | 📅 2026-09-14: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,801 | 🐛 160 | 🌐 Python | 📅 2026-09-07: Falcon is a low-level, high-performance Python framework for building HTTP APIs, app backends, and higher-level frameworks.
* [flask-restful](https://github.com/flask-restful/flask-restful) ⭐ 6,912 | 🐛 145 | 🌐 Python | 📅 2024-07-19: Simple framework for creating REST APIs.
...
* [Connexion](https://github.com/zalando/connexion) ⭐ 4,611 | 🐛 186 | 🌐 Python | 📅 2026-09-07: Swagger/OpenAPI First framework for Python on top of Flask with automatic endpoint validation and OAuth2 support
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,662 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,158 | 🐛 34 | 🌐 Go | 📅 2026-09-14: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [Yesod](https://github.com/yesodweb/yesod) ⭐ 2,724 | 🐛 133 | 🌐 Haskell | 📅 2026-09-14: The Haskell RESTful web framework.
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,665 | 🐛 398 | 🌐 Haskell | 📅 2026-09-13: Serve a RESTful API from any existing PostgreSQL database.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,291 | 🐛 335 | 🌐 PHP | 📅 2026-09-10: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
...
* [Dream Factory](https://github.com/dreamfactorysoftware/dreamfactory) ⭐ 1,786 | 🐛 0 | 🌐 Shell | 📅 2026-08-18: Turn any database into an API platform.

## API Client Development Tools

### General

* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,738 | 🐛 5,752 | 🌐 Java | 📅 2026-09-14: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
...
* [AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 25 | 🌐 TypeSpec | 📅 2026-09-13: Generate client libraries for RESTful web services

### Ruby

* [faraday](https://github.com/lostisland/faraday) ⭐ 5,951 | 🐛 80 | 🌐 Ruby | 📅 2026-09-14: Simple, but flexible HTTP client library, with support for multiple backends.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,010 | 🐛 1,127 | 🌐 JavaScript | 📅 2026-09-11: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,908 | 🐛 449 | 🌐 TypeScript | 📅 2026-09-11: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Elements](https://github.com/stoplightio/elements) ⭐ 2,462 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-09: Web Components-based API documentation for OpenAPI 3.x/2.x
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,304 | 🐛 822 | 🌐 TypeScript | 📅 2026-09-14: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,194 | 🐛 201 | 🌐 Rust | 📅 2026-09-14: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,725 | 🐛 20 | 🌐 Rust | 📅 2026-09-03: A feature-full TUI API client made in Rust. ATAC is free, open-source, offline and account-less.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,707 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,839 | 🐛 924 | 🌐 Go | 📅 2026-09-14: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,340 | 🐛 237 | 🌐 Go | 📅 2026-09-10: A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by [consul](https://www.consul.io) by eBay.
...
* [API Security checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,317 | 🐛 2 | 📅 2026-07-21: Checklist of the most important security countermeasures when designing, testing, and releasing your API.
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,539 | 🐛 97 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,194 | 🐛 201 | 🌐 Rust | 📅 2026-09-14: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,766 | 🐛 863 | 🌐 Java | 📅 2026-09-14: A tool to test your API for known security vulnerabilities, with a great CI integration.
