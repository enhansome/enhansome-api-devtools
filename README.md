...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,214 | 🐛 80 | 🌐 Markdown | 📅 2026-09-11
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,206 | 🐛 221 | 🌐 TypeScript | 📅 2026-09-17: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,005 | 🐛 236 | 🌐 Ruby | 📅 2026-09-17: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,397 | 🐛 80 | 🌐 Python | 📅 2026-09-14: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,639 | 🐛 148 | 🌐 Python | 📅 2026-07-29: Sanic is a Flask-like Python 3.5+ web server that's written to go fast.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,800 | 🐛 158 | 🌐 Python | 📅 2026-09-17: Falcon is a low-level, high-performance Python framework for building HTTP APIs, app backends, and higher-level frameworks.
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,736 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-17: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,161 | 🐛 35 | 🌐 Go | 📅 2026-09-17: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [Akka HTTP](https://github.com/akka/akka-http) ⭐ 1,351 | 🐛 581 | 🌐 Scala | 📅 2026-09-16: The Akka HTTP modules implement a full server- and client-side HTTP stack on top of akka-actor and akka-stream.
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,670 | 🐛 402 | 🌐 Haskell | 📅 2026-09-17: Serve a RESTful API from any existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,618 | 🐛 153 | 🌐 Go | 📅 2026-09-17: pREST is a way to serve a RESTful API from any databases written in Go.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,291 | 🐛 334 | 🌐 PHP | 📅 2026-09-17: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
* [Dingo API](https://github.com/dingo/api) ⭐ 9,375 | 🐛 189 | 🌐 PHP | 📅 2022-05-19: A RESTful API package for the Laravel and Lumen frameworks
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,184 | 🐛 3 | 🌐 PHP | 📅 2026-09-01: API framework on top of Symfony with JSON-LD, Schema.org and Hydra support
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,745 | 🐛 5,748 | 🌐 Java | 📅 2026-09-17: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
...
* [faraday](https://github.com/lostisland/faraday) ⭐ 5,950 | 🐛 78 | 🌐 Ruby | 📅 2026-09-16: Simple, but flexible HTTP client library, with support for multiple backends.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,054 | 🐛 1,125 | 🌐 JavaScript | 📅 2026-09-16: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,913 | 🐛 447 | 🌐 TypeScript | 📅 2026-09-16: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,330 | 🐛 823 | 🌐 TypeScript | 📅 2026-09-16: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,203 | 🐛 199 | 🌐 Rust | 📅 2026-09-17: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Prism](https://github.com/stoplightio/prism) ⭐ 5,032 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-03: a set of packages for API mocking and contract testing with OpenAPI v2 (formerly known as Swagger) and OpenAPI v3.x, including mock servers and a validation proxy.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,709 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/master/Guidelines.md) ⭐ 23,334 | 🐛 179 | 📅 2026-08-05
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,880 | 🐛 937 | 🌐 Go | 📅 2026-09-17: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,341 | 🐛 242 | 🌐 Go | 📅 2026-09-15: A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by [consul](https://www.consul.io) by eBay.
* [Oathkeeper](https://github.com/ory/oathkeeper) ⭐ 3,601 | 🐛 107 | 🌐 Go | 📅 2026-07-27: OIdentity & Access Proxy (IAP) that authorizes HTTP requests based on sets of rules. Integrates with ORY Hydra.
...
* [API Security checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,318 | 🐛 2 | 📅 2026-07-21: Checklist of the most important security countermeasures when designing, testing, and releasing your API.
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,547 | 🐛 98 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Cherrybomb](https://github.com/blst-security/cherrybomb) ⭐ 1,236 | 🐛 38 | 🌐 Rust | 📅 2024-10-25: Stop half-done API specifications! Cherrybomb is a CLI tool that helps you avoid undefined user behaviour by validating your API specifications.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,203 | 🐛 199 | 🌐 Rust | 📅 2026-09-17: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,783 | 🐛 861 | 🌐 Java | 📅 2026-09-17: A tool to test your API for known security vulnerabilities, with a great CI integration.
...
[Pull Requests](https://github.com/yosriady/api-development-tools/pulls) ⭐ 4,018 | 🐛 51 | 📅 2025-12-20 are most welcome!
