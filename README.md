...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,165 | 🐛 118 | 🌐 Markdown | 📅 2026-08-21
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,007 | 🐛 241 | 🌐 Ruby | 📅 2026-08-21: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,742 | 🐛 75 | 🌐 Python | 📅 2026-08-19: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,418 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-21: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
* [Restify](https://github.com/restify/node-restify) ⭐ 10,685 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-21: Node.js REST framework specifically meant for web service APIs.
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,070 | 🐛 54 | 🌐 Go | 📅 2026-08-21: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [Servant](https://github.com/haskell-servant/servant) ⭐ 1,965 | 🐛 299 | 🌐 Haskell | 📅 2026-08-20: A Type-Level Web DSL.
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,617 | 🐛 390 | 🌐 Haskell | 📅 2026-08-21: Serve a RESTful API from any existing PostgreSQL database.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,299 | 🐛 320 | 🌐 PHP | 📅 2026-08-20: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,682 | 🐛 5,719 | 🌐 Java | 📅 2026-08-21: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
...
* [Serverpod](https://github.com/serverpod/serverpod) ⭐ 3,251 | 🐛 497 | 🌐 Dart | 📅 2026-08-21: Serverpod is a next-generation app and web server, built for the Flutter community. It allows you to write your server-side code in Dart, automatically generate your APIs, and hook up your database with minimal effort. Serverpod is open-source, and you can host your server anywhere.

## API Documentation

* [Slate](https://github.com/lord/slate) ⚠️ Archived: Static site generated documentation for your API.
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,980 | 🐛 1,138 | 🌐 JavaScript | 📅 2026-08-21: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,885 | 🐛 448 | 🌐 TypeScript | 📅 2026-08-20: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,070 | 🐛 799 | 🌐 TypeScript | 📅 2026-08-20: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,153 | 🐛 204 | 🌐 Rust | 📅 2026-08-21: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Prism](https://github.com/stoplightio/prism) ⭐ 5,011 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-13: a set of packages for API mocking and contract testing with OpenAPI v2 (formerly known as Swagger) and OpenAPI v3.x, including mock servers and a validation proxy.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,680 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,528 | 🐛 912 | 🌐 Go | 📅 2026-08-21: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [Oathkeeper](https://github.com/ory/oathkeeper) ⭐ 3,595 | 🐛 108 | 🌐 Go | 📅 2026-07-27: OIdentity & Access Proxy (IAP) that authorizes HTTP requests based on sets of rules. Integrates with ORY Hydra.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,489 | 🐛 94 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,153 | 🐛 204 | 🌐 Rust | 📅 2026-08-21: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,654 | 🐛 854 | 🌐 Java | 📅 2026-08-21: A tool to test your API for known security vulnerabilities, with a great CI integration.
