...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,212 | 🐛 80 | 🌐 Markdown | 📅 2026-09-11
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,205 | 🐛 223 | 🌐 TypeScript | 📅 2026-09-15: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,005 | 🐛 237 | 🌐 Ruby | 📅 2026-09-16: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,367 | 🐛 78 | 🌐 Python | 📅 2026-09-14: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,800 | 🐛 159 | 🌐 Python | 📅 2026-09-07: Falcon is a low-level, high-performance Python framework for building HTTP APIs, app backends, and higher-level frameworks.
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,730 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-16: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,160 | 🐛 34 | 🌐 Go | 📅 2026-09-16: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,670 | 🐛 404 | 🌐 Haskell | 📅 2026-09-16: Serve a RESTful API from any existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,618 | 🐛 153 | 🌐 Go | 📅 2026-09-16: pREST is a way to serve a RESTful API from any databases written in Go.
...
* [Yii2 Framework](https://github.com/yiisoft/yii2) ⭐ 14,290 | 🐛 335 | 🌐 PHP | 📅 2026-09-10: Provides a whole set of tools to simplify the task of implementing RESTful Web Service APIs
...
* [Dream Factory](https://github.com/dreamfactorysoftware/dreamfactory) ⭐ 1,787 | 🐛 0 | 🌐 Shell | 📅 2026-08-18: Turn any database into an API platform.

## API Client Development Tools

### General

* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,742 | 🐛 5,749 | 🌐 Java | 📅 2026-09-16: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,013 | 🐛 1,123 | 🌐 JavaScript | 📅 2026-09-16: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,909 | 🐛 447 | 🌐 TypeScript | 📅 2026-09-16: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,322 | 🐛 825 | 🌐 TypeScript | 📅 2026-09-16: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,198 | 🐛 198 | 🌐 Rust | 📅 2026-09-16: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Prism](https://github.com/stoplightio/prism) ⭐ 5,030 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-03: a set of packages for API mocking and contract testing with OpenAPI v2 (formerly known as Swagger) and OpenAPI v3.x, including mock servers and a validation proxy.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,705 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,867 | 🐛 933 | 🌐 Go | 📅 2026-09-16: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,544 | 🐛 98 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,198 | 🐛 198 | 🌐 Rust | 📅 2026-09-16: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,777 | 🐛 863 | 🌐 Java | 📅 2026-09-15: A tool to test your API for known security vulnerabilities, with a great CI integration.
