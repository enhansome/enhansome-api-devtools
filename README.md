...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,213 | 🐛 80 | 🌐 Markdown | 📅 2026-09-11
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,205 | 🐛 224 | 🌐 TypeScript | 📅 2026-09-15: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,005 | 🐛 238 | 🌐 Ruby | 📅 2026-09-15: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,350 | 🐛 77 | 🌐 Python | 📅 2026-09-14: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,661 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-15: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,158 | 🐛 34 | 🌐 Go | 📅 2026-09-15: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [Servant](https://github.com/haskell-servant/servant) ⭐ 1,965 | 🐛 299 | 🌐 Haskell | 📅 2026-09-08: A Type-Level Web DSL.
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,668 | 🐛 402 | 🌐 Haskell | 📅 2026-09-15: Serve a RESTful API from any existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,618 | 🐛 156 | 🌐 Go | 📅 2026-09-10: pREST is a way to serve a RESTful API from any databases written in Go.
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,740 | 🐛 5,744 | 🌐 Java | 📅 2026-09-15: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
...
* [faraday](https://github.com/lostisland/faraday) ⭐ 5,950 | 🐛 80 | 🌐 Ruby | 📅 2026-09-15: Simple, but flexible HTTP client library, with support for multiple backends.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,010 | 🐛 1,127 | 🌐 JavaScript | 📅 2026-09-14: Dynamically generate documentation from a Swagger-compliant API.
* [ReDoc](https://github.com/Rebilly/ReDoc) ⭐ 25,908 | 🐛 448 | 🌐 TypeScript | 📅 2026-09-15: OpenAPI/Swagger-generated API Reference Documentation.
...
* [Elements](https://github.com/stoplightio/elements) ⭐ 2,462 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-15: Web Components-based API documentation for OpenAPI 3.x/2.x
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,310 | 🐛 822 | 🌐 TypeScript | 📅 2026-09-14: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,194 | 🐛 199 | 🌐 Rust | 📅 2026-09-15: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Prism](https://github.com/stoplightio/prism) ⭐ 5,029 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-03: a set of packages for API mocking and contract testing with OpenAPI v2 (formerly known as Swagger) and OpenAPI v3.x, including mock servers and a validation proxy.
...
* [Json-Server](https://github.com/typicode/json-server) ⭐ 75,708 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 Full fake REST API with zero coding.
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,851 | 🐛 929 | 🌐 Go | 📅 2026-09-15: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,340 | 🐛 240 | 🌐 Go | 📅 2026-09-15: A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by [consul](https://www.consul.io) by eBay.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,543 | 🐛 98 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,194 | 🐛 199 | 🌐 Rust | 📅 2026-09-15: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,771 | 🐛 863 | 🌐 Java | 📅 2026-09-15: A tool to test your API for known security vulnerabilities, with a great CI integration.
