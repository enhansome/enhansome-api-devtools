...
* [OpenAPI (formerly known as Swagger)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,177 | 🐛 81 | 🌐 Markdown | 📅 2026-08-24
...
* [Spectral](https://github.com/stoplightio/spectral) ⭐ 3,188 | 🐛 273 | 🌐 TypeScript | 📅 2026-08-19: Define rulesets to lint YAML or JSON, including OpenAPI 2.x, 3.x and AsyncAPI
...
* [grape](https://github.com/ruby-grape/grape) ⭐ 10,006 | 🐛 236 | 🌐 Ruby | 📅 2026-08-24: An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,825 | 🐛 80 | 🌐 Python | 📅 2026-08-19: FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.
...
* [Nest](https://github.com/kamilmysliwiec/nest) ⭐ 76,450 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-24: A modern node.js framework for efficient and scalable web applications built on top of TypeScript
...
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,076 | 🐛 49 | 🌐 Go | 📅 2026-08-24: :zap:Fiber is an Express inspired web framework written in Go with :coffee: .
...
* [PostgREST](https://github.com/begriffs/postgrest) ⭐ 27,624 | 🐛 390 | 🌐 Haskell | 📅 2026-08-24: Serve a RESTful API from any existing PostgreSQL database.
...
* [OpenAPI Generator](https://github.com/openapitools/openapi-generator) ⭐ 26,687 | 🐛 5,715 | 🌐 Java | 📅 2026-08-25: A community fork of Swagger Codegen to automatically generate API clients, server stubs and documentation for REST APIs given an OpenAPI/Swagger spec.
...
* [Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,986 | 🐛 1,140 | 🌐 JavaScript | 📅 2026-08-24: Dynamically generate documentation from a Swagger-compliant API.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,093 | 🐛 802 | 🌐 TypeScript | 📅 2026-08-24: API client for REST, GraphQL, Websocket, SSE, Socket.IO and MQTT
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,157 | 🐛 205 | 🌐 Rust | 📅 2026-08-25: Hurl makes it easy to work with HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
...
* [Prism](https://github.com/stoplightio/prism) ⭐ 5,012 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-13: a set of packages for API mocking and contract testing with OpenAPI v2 (formerly known as Swagger) and OpenAPI v3.x, including mock servers and a validation proxy.
...
* [Traefik](https://github.com/containous/traefik) ⭐ 64,573 | 🐛 916 | 🌐 Go | 📅 2026-08-24: Træfik (pronounced like traffic) is a modern HTTP reverse proxy and load balancer written in Go.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,495 | 🐛 94 | 🌐 Go | 📅 2026-07-29: OAuth2 server with OpenID Connect written in Go.
...
* [Hurl](https://github.com/Orange-OpenSource/hurl) ⭐ 19,157 | 🐛 205 | 🌐 Rust | 📅 2026-08-25: Hurl makes it easy to test HTML content, REST / SOAP / GraphQL APIs, or any other XML / JSON based APIs.
* [OWASP Zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,677 | 🐛 859 | 🌐 Java | 📅 2026-08-21: A tool to test your API for known security vulnerabilities, with a great CI integration.
